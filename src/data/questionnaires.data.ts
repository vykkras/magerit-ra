...
export const CATEGORY_QUESTIONNAIRES: Record<string, Question[]> = {
  ...
  'low-impact-it': [
    ...
    { id: 'li-04', domain: 'personas',     text: '¿El proveedor proporciona documentación o materiales para uso seguro de la solución?',  riskRefs: ['E.1', 'A.30'],  safeguardRefs: ['iso-6.1'],  responsibility: 'ambos'     },
    { id: 'li-05', domain: 'personas',     text: '¿La solución define y separa roles administrativos del resto de usuarios?',             riskRefs: ['A.6'],          safeguardRefs: ['iso-5.18'], responsibility: 'ambos'     },
    ...
    { id: 'li-07', domain: 'fisico',       text: '¿La solución funciona correctamente ante fallos eléctricos o condiciones ambientales?', riskRefs: ['I.6', 'I.*'],   safeguardRefs: ['iso-7.11'], responsibility: 'ambos'     },

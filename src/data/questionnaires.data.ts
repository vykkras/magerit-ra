...
export const CATEGORY_QUESTIONNAIRES: Record<string, Question[]> = {
  ...
  // ── SaaS con IA ─────────────────────────────────────────────────────────────
  'saas-ai': [
    { id: 'sa-01', domain: 'tecnologico',  text: '¿La solución incorpora autenticación segura, control de accesos y privilegios sobre funciones IA?',                       riskRefs: ['A.5','A.6'],               safeguardRefs: ['iso-8.5','iso-5.15','iso-5.18'],        responsibility: 'ambos'     },
    { id: 'sa-02', domain: 'tecnologico',  text: '¿La plataforma registra prompts, acciones y eventos relacionados con IA?',                                                 riskRefs: ['A.13','E.3'],              safeguardRefs: ['iso-8.15','iso-8.16'],                  responsibility: 'proveedor' },
    { id: 'sa-03', domain: 'tecnologico',  text: '¿La solución protege datos enviados a IA mediante cifrado y controles DLP?',                                              riskRefs: ['E.14','A.19'],             safeguardRefs: ['iso-8.24','iso-8.12'],                  responsibility: 'ambos'     },
    { id: 'sa-04', domain: 'tecnologico',  text: '¿La solución contempla segregación lógica y aislamiento de datos entre usuarios?',                                        riskRefs: ['A.11'],                    safeguardRefs: ['iso-8.22','iso-5.15'],                  responsibility: 'proveedor' },
    { id: 'sa-05', domain: 'tecnologico',  text: '¿La solución contempla backup, recuperación y continuidad del servicio IA?',                                              riskRefs: ['E.18','I.8'],              safeguardRefs: ['iso-8.13','iso-8.14','iso-5.30'],       responsibility: 'proveedor' },
    { id: 'sa-06', domain: 'tecnologico',  text: '¿La solución contempla gestión de vulnerabilidades y configuraciones seguras de IA?',                                     riskRefs: ['E.20','A.22'],             safeguardRefs: ['iso-8.8','iso-8.9','iso-8.28'],         responsibility: 'proveedor' },
    { id: 'sa-07', domain: 'organizativo', text: '¿Existen responsabilidades definidas para uso, supervisión y seguridad de IA?',                                           riskRefs: ['E.7'],                     safeguardRefs: ['iso-5.2','iso-5.19'],                   responsibility: 'ambos'     },
    { id: 'sa-08', domain: 'personas',     text: '¿Los usuarios reciben formación sobre riesgos y uso seguro de IA?',                                                       riskRefs: ['E.1','A.30'],              safeguardRefs: ['iso-6.3','iso-6.8'],                    responsibility: 'ambos'     },
    { id: 'sa-09', domain: 'fisico',       text: '¿La infraestructura física utilizada por IA posee controles ambientales adecuados?',                                      riskRefs: ['N.1','I.6'],               safeguardRefs: ['iso-7.1','iso-7.11'],                   responsibility: 'proveedor' },
    { id: 'sa-10', domain: 'tecnologico',  text: '¿La solución contempla detección de actividad anómala y abuso de IA?',                                                    riskRefs: ['A.30','A.24'],             safeguardRefs: ['iso-8.16','iso-8.7'],                   responsibility: 'proveedor' },
    { id: 'sa-11', domain: 'organizativo', text: '¿La solución contempla revisión humana y validación de resultados IA?',                                                   riskRefs: ['E.15'],                    safeguardRefs: ['iso-8.29','iso-5.37'],                  responsibility: 'cliente'   },
    { id: 'sa-12', domain: 'tecnologico',  text: '¿La solución contempla privacidad, protección y eliminación segura de información?',                                      riskRefs: ['A.19','E.19'],             safeguardRefs: ['iso-5.34','iso-8.10','iso-8.12'],       responsibility: 'ambos'     },
    { id: 'sa-13', domain: 'organizativo', text: '¿La solución contempla gestión y notificación de incidentes relacionados con IA?',                                        riskRefs: ['E.7'],                     safeguardRefs: ['iso-5.24','iso-5.25','iso-5.26'],       responsibility: 'proveedor' },
    { id: 'sa-14', domain: 'organizativo', text: '¿La solución permite auditoría, revisión y trazabilidad de acciones IA?',                                                 riskRefs: ['A.13'],                    safeguardRefs: ['iso-5.35','iso-5.36','iso-8.15'],       responsibility: 'ambos'     },
    { id: 'sa-15', domain: 'tecnologico',  text: '¿La solución contempla controles sobre APIs, modelos externos y terceros?',                                               riskRefs: ['A.11','A.14'],             safeguardRefs: ['iso-5.19','iso-5.21','iso-8.20'],       responsibility: 'ambos'     },
  ],
